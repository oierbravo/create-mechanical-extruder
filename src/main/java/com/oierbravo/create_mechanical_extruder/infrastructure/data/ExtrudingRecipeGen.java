...
public class ExtrudingRecipeGen extends AbstractMechanicalRecipeGenerator<ExtrudingRecipeBuilder> {
    public ExtrudingRecipeGen(PackOutput output, CompletableFuture<HolderLookup.Provider> registries, String namespace, String recipeTypeId, Supplier<ExtrudingRecipeBuilder> builderSupplier, String displayName) {
    ...
    public ExtrudingRecipeGen(PackOutput output, CompletableFuture<HolderLookup.Provider> registries) {
        this(output, registries,
                MODID,
                ExtrudingRecipe.Type.ID,
                ExtrudingRecipeBuilder::new,
                "Extruding recipes"
        );
    }
